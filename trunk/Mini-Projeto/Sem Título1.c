    ...
    //#pragma omp parallel
    {
        ...
        for (i = 0; i < altura; i++){
            for (k = 0; k < largura; k++){
                ...
                matrizL[i][k].real = (somaReal/largura);
                matrizL[i][k].imag = somaImag;
                somaReal = 0.0;
                somaImag = 0.0;
            }
        ...
        for (i = 0; i < largura; i++){
            for (k = 0; k < altura; k++){
                ...
                matrizC[k][i].real = (somaReal/altura);
                matrizC[k][i].imag = somaImag;
                somaReal = 0.0;
                somaImag = 0.0;
            }
        ...
        for (i = 0; i < largura; i++){
            for (k = 0; k < altura; k++){                
                if(matrizC[k][i].real > 255)
                    matrizC[k][i].real=255;
                if(matrizC[k][i].real < 0)
                    matrizC[k][i].real = 0;
            }
        }
    }
...
int main(int argc, char argv[]){
    ...
    const char *imagemFinal = "fourier.pgm";
